	...
	<header id="header">
		...
		<nav id="myTopNav" class="navtoggle">
			<ul class="header_list">
				<li class="active"><a href="http://localhost/shoptrack/index1.php">HOME</a></li>
				<li><a href="it project/aboutus.html">About</a></li>
				<li><a href="shoppingcart2/index.php?page=products">Products</a></li>
                <li><a href="#">Log in</a>
                    <div class="sub-menu">
                        <ul>
                            <li><a href="admin/login.php">Admin</a></li>
                            <li><a href="customer-login/home.php">Customer</a></li>
                            <li><a href="admin/index.php">Vendor</a></li>
                        </ul>
					</div>
                </li>
